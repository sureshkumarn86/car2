...
<section class="b-slider"> 
			<div id="carousel" class="slide carousel carousel-fade">
				<div class="carousel-inner">
					<div class="item active">
						<img src="http://saravanank.com/car/wp-content/uploads/2018/06/1.jpg" alt="sliderImg" />
						<div class="container">
				...
				<div id="carousel-small" class="owl-carousel enable-owl-carousel" data-items="4" data-navigation="true" data-auto-play="true" data-stop-on-hover="true" data-items-desktop="4" data-items-desktop-small="4" data-items-tablet="3" data-items-tablet-small="2">
					<div>
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							<a href="#">
								<img src="http://saravanank.com/car/wp-content/uploads/2018/06/mers.jpg" alt="mers" />
					...
					<div>
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							<a href="#">
								<img src="http://saravanank.com/car/wp-content/uploads/2018/06/audi.jpg" alt="audi" />
							</a>
							<div class="b-featured__item-price">
								$95,900
							</div>
					...
					<div>
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							<a href="#">
								<img src="http://saravanank.com/car/wp-content/uploads/2018/06/aston.jpg" alt="aston" />
					...
					<div>
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							<a href="#">
								<img src="http://saravanank.com/car/wp-content/uploads/2018/06/jaguar.jpg" alt="jaguar" />
							</a>
							<div class="b-featured__item-price">
								$130,825
							</div>
		...
		<h2 class="s-title wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">Recent Articles</h2>
				<div class="row">
					<div class="col-sm-4 col-xs-12">
						<div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
							<img class="img-responsive" src="http://saravanank.com/car/wp-content/uploads/2018/06/wolks.jpg" alt="wolks" />
							...
							<a href="#" class="btn m-btn">READ MORE<span class="fa fa-angle-right"></span></a>
						</div>
					</div>
					<div class="col-sm-4 col-xs-12">
						<div class="b-world__item wow zoomInUp" data-wow-delay="0.3s" data-wow-offset="100">
							<img class="img-responsive"  src="http://saravanank.com/car/wp-content/uploads/2018/06/mazda.jpg" alt="mazda" />
							<div class="b-world__item-val">
							...
							<a href="#" class="btn m-btn m-active">READ MORE<span class="fa fa-angle-right"></span></a>
						</div>
					</div>
					<div class="col-sm-4 col-xs-12">
						<div class="b-world__item j-item wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">
							<img class="img-responsive"  src="http://saravanank.com/car/wp-content/uploads/2018/06/chevrolet.jpg" alt="chevrolet" />
							<div class="b-world__item-val">
		...
		<section class="b-auto">
			<div class="container">
				<h2 class="s-title wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">Popular Used Cars in UAE </h2>
				<div class="row">
					...
					<div class="col-md-9 col-sm-8 col-xs-12">
						<div class="b-auto__main">
							<div class="col-md-11 col-md-offset-1 col-xs-12">
								<a href="#"  class="b-auto__main-toggle s-lineDownCenter m-active j-tab wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100" data-to="#first">
                  Featured Cars</a>
								<a href="#" class="b-auto__main-toggle j-tab wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100" data-to="#second">Recent Cars</a>
							</div>
							<div class="clearfix"></div>
							<div class="row m-margin" id="first">
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										<img class="img-responsive"  src="http://saravanank.com/car/wp-content/uploads/2018/06/acura.jpg" alt="mazda" />
										<div class="b-world__item-val">
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										<img class="img-responsive"  src="http://saravanank.com/car/wp-content/uploads/2018/06/nissan.jpg" alt="mazda" />
										<div class="b-world__item-val">
											<span class="b-world__item-val-title">REGISTERED <span>2014</span></span>
										</div>
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										<img class="img-responsive"  src="http://saravanank.com/car/wp-content/uploads/2018/06/acura2016.jpg" alt="mazda" />
										<div class="b-world__item-val">
											<span class="b-world__item-val-title">REGISTERED <span>2014</span></span>
										</div>
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										<img class="img-responsive"  src="http://saravanank.com/car/wp-content/uploads/2018/06/amg.jpg" alt="mazda" />
										<div class="b-world__item-val">
											<span class="b-world__item-val-title">REGISTERED <span>2014</span></span>
										</div>
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										<img class="img-responsive"  src="http://saravanank.com/car/wp-content/uploads/2018/06/brabus.jpg" alt="mazda" />
										<div class="b-world__item-val">
											<span class="b-world__item-val-title">REGISTERED <span>2014</span></span>
										</div>
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										<img class="img-responsive"  src="http://saravanank.com/car/wp-content/uploads/2018/06/range.jpg" alt="mazda" />
										<div class="b-world__item-val">
											<span class="b-world__item-val-title">REGISTERED <span>2014</span></span>
										</div>
		...
		<section class="b-review">
						...
						<div class="b-review__main">
							<div class="b-review__main-person">
								<div class="b-review__main-person-inside">
									<img src="http://saravanank.com/car/wp-content/uploads/2018/06/person.jpg" alt="" />
								</div>
							</div>
			...
			<img src="http://saravanank.com/car/wp-content/uploads/2018/06/reviews.jpg" alt="" class="img-responsive center-block" />
		</section><!--b-review-->
